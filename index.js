...
function checkIfStartsWith(mainStr, subStr) {
  ...
  // Використовуємо метод startsWith(), щоб перевірити, чи починається рядок mainStr
  //з певного підрядка subStr
}
...
function padString(original, length, padWith, side) {
  ...
  // Використовуємо метод padStart(), щоб доповнити рядок string до певної довжини length,
  //вставляючи символи padWith на початку
  // Якщо "end", використовуємо padEnd
  // Використовуємо метод padStart(), щоб доповнити рядок string до певної довжини length,
  //вставляючи символи padWith на в кінці
  ...
  if (side === "start") {
    ...
    return 'Invalid side value. Please use "start" or "end".';
  }
}
...
function sliceString(string, startIndex, endIndex) {
  // Використовуємо метод slice(), щоб видалити частину рядка string між
  //двома індексами startIndex та endIndex
